...
class Strap_With_Hole_Generator_on_Sheet:
    ...
    def read_connectivity_from_strap_without_hole_knitgraph(self):
        """
        ...
        """
        strap_without_hole_knitgraph_edge_data_list = self.strap_without_hole_knitgraph.graph.edges(data=True)
        for edge_data in strap_without_hole_knitgraph_edge_data_list:
            node = edge_data[1]
            node_coor = self.strap_without_hole_knitgraph.node_to_course_and_wale[node]
            predecessor = edge_data[0]
            predecessor_coor = self.strap_without_hole_knitgraph.node_to_course_and_wale[predecessor]
            attr_dict = edge_data[2]
            self.strap_without_hole_knitgraph_coors_connectivity.append([predecessor_coor, node_coor, attr_dict])
    ...
    def build_strap_with_hole_graph(self) -> Knit_Graph:   
        ...
        self.read_connectivity_from_strap_without_hole_knitgraph()
